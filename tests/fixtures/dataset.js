...
const stocks = [
  ['NVDA', semiconductor, ['ai', 'semiconductor-ai']],
  ['CRWV', 'software', ['ai', 'ai-cloud']],
  ['MSTR', 'software', ['digital-assets', 'bitcoin-treasury']],
  ['TSLA', 'automobiles'],
...
const funds = [
  ['SPY', ['us-large-cap']],
  ['QQQ', ['nasdaq-100']],
  ['SOXL', ['leveraged', 'semiconductor-sector']],
  ['KWEB', ['china-internet']],
  ['GLD', ['gold']],
  ['TLT', ['us-long-treasury']],
  ['IBIT', ['digital-assets', 'bitcoin']],
];
...
export function createDatasetFixture() {
  ...
  const instruments = stocks.map(([symbol, industryId, tags], index) => {
    const item = record(index, symbol, tags);
